            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                <div className='grid grid-cols-2 gap-6 mt-10 mb-8'>
                   <input 
                    ...
                    dark:bg-[#210c39]/30 dark:border-white/90'
                    name='name'
                   />
                  <input 
                    type="email" 
                    ...
                    required
                    className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white 
                    dark:bg-[#2d124b]/30 dark:border-white/90'
                    name='email'
                   />
                </div>
                <textarea 
                ...
                mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-[#2d124b]'>
